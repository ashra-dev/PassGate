...
<?php elseif ($active_tab === 'dashboard'): ?>
    ...
    <div class="summary-grid">
        ...
        <div class="summary-card"><h3>Vault Pool</h3><div class="metric"><?php echo (int) $summary['unallocated']; ?></div></div>
    </div>
...
<?php elseif ($active_tab === 'ledger'): ?>
    ...
    <div class="summary-grid">
        ...
        <div class="summary-card"><h3>Allocated</h3><div class="metric"><?php echo (int) $summary['allocated']; ?></div></div>
        <div class="summary-card"><h3>In Vault</h3><div class="metric"><?php echo (int) $summary['unallocated']; ?></div></div>
    </div>
    <?php if ($tickets === []): ?>
        <div class="pg-empty">
    ...
    <?php else: ?>
        <table>
            <thead><tr><th>Ticket ID</th><th>Physical #</th><th>Tier</th><th>Price</th><th>Handler</th><th>Benefits</th></tr></thead>
            <tbody>
...
<?php elseif ($active_tab === 'allocation'): ?>
    <?php
    $vaultTickets = array_values(array_filter($tickets, static fn ($row) => empty($row['allocated_distributor_id'])));
